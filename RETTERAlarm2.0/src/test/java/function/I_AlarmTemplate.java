...
public class I_AlarmTemplate extends b_baseClass {
	...
	private WebElement temAlarmTitle;
...
//		
	...
	public void createNewAlarmTemplateByAttribute(WebDriver driver, String gTodaysDate, String gtimeHHMMSS, String St2N,
		...
		act.moveToElement(createNewButton).click().build().perform();
		Thread.sleep(2000);

		act.moveToElement(alarmTemplateTitleField).click().build().perform();
		String title = "BG_AT by Atrribute_" + gTodaysDate + "_" + gtimeHHMMSS;
		act.sendKeys(title).perform();
		Thread.sleep(2000);
		...
		act.moveToElement(alarmKeyword).click().build().perform();
		act.sendKeys("BG-MA by newly added tem -" + gTodaysDate + "_" + gtimeHHMMSS).build().perform();

		act.moveToElement(alarmImage).click().build().perform();
		act.sendKeys("Image-Alarm template by attribute.").build().perform();

		act.moveToElement(descriptionField).click().build().perform();
		act.sendKeys("checking Alarm template by attribute.").build().perform();

		act.moveToElement(reporter).click().build().perform();
		Thread.sleep(1000);
		...
		// reporterName.click();
		act.moveToElement(reporterName).click().build().perform();
		act.sendKeys("Dr. Sumit ").build().perform();

		act.moveToElement(reporterStreet).click().build().perform();
		act.sendKeys("Kharbi Road, Nagpur").build().perform();

		act.moveToElement(reporterZipCode).click().build().perform();
		act.sendKeys("440009").build().perform();

		act.moveToElement(reporterMobileNo).click().build().perform();
		act.sendKeys("1122334455").build().perform();

		act.moveToElement(reporterCallback).click().build().perform();
		act.sendKeys("10").build().perform();
		...
		act.moveToElement(alarmAddress).click().build().perform();
		act.sendKeys("BAPS Swaminarayan mandir, Wathoda Layout, Nagpur, Maharashtra 440035").build().perform();
		...
		act.moveToElement(alarmObject).click().build().perform();
		act.sendKeys("hospital").perform();

		act.moveToElement(alarmFloor).click().build().perform();
		act.sendKeys("ground floor").perform();

		act.moveToElement(alarmAnnotation).click().build().perform();
		act.sendKeys("alarm annotation").perform();
		...
		act.moveToElement(userTypeAttribute).click().build().perform();
		Thread.sleep(2000);

		act.moveToElement(vehicleField1).click().build().perform();
		...
		act.moveToElement(attributeField).click().build().perform();
		...
		act.moveToElement(saveTemplate).click().build().perform();
		Thread.sleep(500);

		act.moveToElement(yesCreateTemplate).click().build().perform();
		Thread.sleep(5000);
...
//		selectAlarmStationsField.click();
		...
		act.moveToElement(reporterName).click().sendKeys("Dr. Sumit ").build().perform();
		act.moveToElement(reporterStreet).click().sendKeys("Kharbi Road, Nagpur").build().perform();
		act.moveToElement(reporterZipCode).click().sendKeys("440009").build().perform();
		act.moveToElement(reporterMobileNo).click().sendKeys("1122334455").build().perform();
		act.moveToElement(reporterCallback).click().sendKeys("10").build().perform();
...
//		act.sendKeys(Keys.TAB).sendKeys(Keys.ENTER).build().perform();
		...
		act.moveToElement(FirefighterField2).click().build().perform();
