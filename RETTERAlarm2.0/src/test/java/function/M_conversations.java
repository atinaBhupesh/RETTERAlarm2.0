...
public class M_conversations extends b_baseClass {
	...
	@FindBy(xpath = "(//div[@class=\"chat-text\"])[last()]")
	private WebElement textMessage;

	@FindBy(xpath = "//h2[starts-with(text(),'BG')]")
...
//		System.out.println(expChatGroupName);
//		System.out.println(ChatGroupByFireFighterMS);
...

	{
		...
		Thread.sleep(2000);
//		textarea.click();
		act.moveToElement(textarea).click().perform();
