...
public class J_alarmEscalation extends b_baseClass {
	...
	@FindBy(xpath = "//a[@href=\"https://admin.retteralarm.de/verify-user?returnUrl=/admin/alarm-escalation/list\"]")
	private WebElement alarmEsclationL;
	@FindBy(xpath = "//a[@href=\"href=\"http://admin.testing.retteralarm.de/verify-user?returnUrl=/admin/alarm-escalation/list\"]")
	private WebElement alarmEsclationT;
	@FindBy(xpath = "//a[@href=\"href=\"https://admin.development.retteralarm.de/verify-user?returnUrl=/admin/alarm-escalation/list\"]")
	private WebElement alarmEsclationD;
	...
	@FindBy(xpath = "//label[text()=\"Stations *\"]")
	private WebElement sation;
	...
	@FindBy(xpath = "//input[@placeholder=\"Select Parent Resource\"]")
	private WebElement selectParentResource;
	@FindBy(xpath = "(//input[@placeholder=\"Select...\"])[4]")
	private WebElement select1stChildResource;
	@FindBy(xpath = "//dx-button[@title=\"Define Time Frame\"]")
	private WebElement timeBetweenResource1st;

	@FindBy(xpath = "//span[text()=\"Anzahl der Benutzer\" or text()=\"No. of User\"]")
	private WebElement noOfUsers;
	@FindBy(xpath = "//dx-select-box[@class=\"dx-validator dx-visibility-change-handler dx-show-invalid-badge dx-selectbox dx-textbox dx-texteditor dx-dropdowneditor-button-visible dx-editor-filled dx-widget dx-dropdowneditor dx-dropdowneditor-field-clickable dx-state-hover\"]")
	private WebElement selectMin;
	@FindBy(xpath = "(//span[text()=\"Speichern\" or text()=\"Save\"])[2]")
	private WebElement saveTime;
	@FindBy(xpath = "//span[text()=\"Attributes and Quantity\" or text()=\"Attribute und Menge\"]")
	private WebElement atrributeQuantity;
	@FindBy(xpath = "(//div[@class=\"dx-switch-inner\"])[2]")
	private WebElement matchCount;
	@FindBy(xpath = "(//span[text()=\"Speichern\" or text()=\"Save\"])[1]")
	private WebElement saveTime1;
	...
	@FindBy(xpath = "//td[contains(text(),\"BG_ResourceEsc\")]")
	private List<WebElement> BgRespurceEsc;
	...
	public void createNewAlarmEscalation(WebDriver driver, String st01N, String NewResourceEsc, String branchNam)
			throws Throwable {
