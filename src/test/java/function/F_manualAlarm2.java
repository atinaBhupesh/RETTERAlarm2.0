...
public class F_manualAlarm2 extends b_baseClass{
	...
	public F_manualAlarm2(WebDriver driver) {
	...
	public void manualaByAttributeExtend1StStResource (WebDriver driver,String St2N, String gTodaysDate, String gtimeHHMMSS,String St2V1,  String st02A1, String St1N, String branchName ) throws Throwable
	{
	...
	for (int i=0;i<=9;i++)
	{
		...
		addExtension.click();
		Thread.sleep(2000);
		extendStationField.click();
		act.sendKeys(St1N).build().perform();
		Thread.sleep(1000);
		act.sendKeys(Keys.ENTER).build().perform();
		Thread.sleep(1000);
		extendUsereTypeResource.click();
		...
		additionalInformation1.click();
		
		Thread.sleep(1000);
		act.sendKeys("additional field 01").perform();
		Thread.sleep(1000);
		saveExtend.click();
		Thread.sleep(5000);
		...
		
	{
		...
		Thread.sleep(5000);
			        ...
			        int count1 =BGAlarm.size();	
		 			...
		 			{
		 			System.out.println();
				 	System.out.println(count1 + " Alarms are available for deletion in the 1st batch."); 
				 	System.out.println();
		 		  ...
		 		  driver.navigate().refresh();
		 		   Thread.sleep(30000);
		 			...
		 			int count2 =BGAlarm.size();	
		 			
		 			if (count2>=1)
		 			{
		 				System.out.println();
			 			System.out.println(count2 + " Alarms are available for deletion in the 2nd batch."); 
			 			System.out.println();
		 		  ...
		 		  driver.navigate().refresh();
		 		   Thread.sleep(30000);
		 			...
		 			if (count3>=1)
		 			{
		 				...
		 				System.out.println();
			 			System.out.println(count3 + " Alarms are available for deletion in the 3rd batch."); 
			 			System.out.println();
		 			selectAll.click();
		 		    Thread.sleep(2000);
		 		  ...
		 		  driver.navigate().refresh();
		 		   Thread.sleep(30000);
		 			...
		 			if (count4>=1)
		 			{
		 				...
		 				System.out.println();
			 			System.out.println(count4 + " Alarms are available for deletion in the 4th batch."); 
			 			System.out.println();
		 		  ...
		 		  int count5 =BGAlarm.size();	
		 			
		 			
		 			if (count5>=1)
		 			{
		 				System.out.println();
			 			System.out.println(count5 + " Alarms are available for deletion in the 5th batch."); 
			 			System.out.println();
		 			selectAll.click();
		 		    Thread.sleep(2000);
		 		  ...
		 		  driver.navigate().refresh();
		 		   Thread.sleep(30000);
		 			 ...
		 			 int count6 =BGAlarm.size();	
			 			
			 			
			 			if (count6>=1)
			 			{
			 				System.out.println();
				 			System.out.println(count6 + " Alarms are available for deletion in the 6th batch."); 
				 			System.out.println();
			 			selectAll.click();
			 		    Thread.sleep(2000);
			 		  ...
			 		  driver.navigate().refresh();
			 		   Thread.sleep(30000);
			 			...
			 			int count7 =BGAlarm.size();	
			 			
			 			
			 			if (count7>=1)
			 			{
			 				System.out.println();
				 			System.out.println(count7 + " Alarms are available for deletion in the 7th batch."); 
				 			System.out.println();
			 			selectAll.click();
			 		    Thread.sleep(2000);
			 		  ...
			 		  driver.navigate().refresh();
			 		   Thread.sleep(30000);
			 			...
			 			int count8 =BGAlarm.size();	
			 			if (count8>=1)
			 			{
			 				System.out.println();
				 			System.out.println(count8 + " Alarms are available for deletion in the 8th batch."); 
				 			System.out.println();
			 			selectAll.click();
			 		    Thread.sleep(2000);
			 		  ...
			 		  driver.navigate().refresh();
			 		   Thread.sleep(30000);
			 			...
			 			int count9 =BGAlarm.size();	
			 			if (count9>=1)
			 			{
			 				System.out.println();
				 			System.out.println(count9 + " Alarms are available for deletion in the 9th batch."); 
				 			System.out.println();
			 			selectAll.click();
			 		    Thread.sleep(2000);
			 		  ...
			 		  driver.navigate().refresh();
			 		   Thread.sleep(30000);
			 			...
			 			int count10 =BGAlarm.size();	
			 			if (count10>=1)
			 			{
			 				System.out.println();
				 			System.out.println(count10 + " Alarms are available for deletion in the 10th batch."); 
				 			System.out.println();
			 			selectAll.click();
			 		    Thread.sleep(2000);
		 			...
		 			int totalAlarms=count10+count9+count8+count7+count6+count5+count4+count3+count2+count1;
