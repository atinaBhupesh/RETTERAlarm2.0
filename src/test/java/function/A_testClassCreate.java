...
public class A_testClassCreate extends b_baseClass {
...

	{
		...
		Reporter.log("The process for checking validation for calendar event has been completed successfully.", true);
		Reporter.log(" ", true);
		Thread.sleep(3000);
...

	{
		...
		Reporter.log("The process for creating a new Information-Event using resource has been completed successfully.",
				true);
		Reporter.log(" ", true);
		Thread.sleep(3000);
...

	{
		...
		info.createMonitorInformationByAttribute(driver, st01N, gTodaysDate, gtimeHHMMSS, st01A1, St01M1, St01M2,
				germanyTimeAfter5MinHH, germanyTimeAfter5MinMM, germanyTimeAfter20MinHH, germanyTimeAfter20MinMM,
				branchName);
		Reporter.log(
				"The process for creating a new monitor information using attributes has been completed successfully.",
				true);
		Reporter.log(" ", true);
		Thread.sleep(3000);
...

	{
		...
		ma.manualaByAttributeMSLP(driver, st01N, st02N, gTodaysDate, gtimeHHMMSS, st01V1, st01V2, st02V1, st01A1,
				st02A1);
		Reporter.log("The process of creating a low priority multi station manual alarm by attribute is complete.",
				true);
		Reporter.log(" ", true);
		Thread.sleep(3000);
