...
import org.testng.Assert;
	...
	public class H_alarmLoop extends b_baseClass {
		...
		@FindBy(xpath="//td[contains (text(),'BG')]")private List<WebElement> BGAlarmLoop ;
		 ...
		 @FindBy(xpath="//h2[text()=\"Alarm loop\"]")private WebElement alarmLoopTitle;
		 @FindBy(xpath="//h2[text()=\"Create Loop\"]")private WebElement createLoopTitle;
		@FindBy(xpath="//div[text()=\"Fire Station is required.\"]")private WebElement fireStationIsRequriedValidation;
		 @FindBy(xpath="//div[text()=\"Nickname is required.\"]")private WebElement nicnmaeIsRequriedValidation ;
		 @FindBy(xpath="//div[text()=\"Alarm Code is required.\"]")private WebElement alarmCodeIsRequriedValidation;
		 @FindBy(xpath="//div[text()=\"Alarm resource is required.\"]")private WebElement alarmResourceIsRequriedValidation;
		 @FindBy(xpath="//div[contains(@class,'dx-selectbox-popup')]")private WebElement stationNameList;
		 @FindBy(xpath="//input[@role='combobox' and @placeholder='Select Resources']")private WebElement resoursceNameList ;
		 @FindBy(xpath="//button[@class=\"btn-success mtop28\"]")private WebElement createNewAlarmLoopButton;
				 @FindBy(xpath="//div[text()=\"Create Resource\"]")private WebElement createResourceTitle;
				 @FindBy(xpath="//input[@name=\"name\"]")private WebElement ResourceNameInputField;
				@FindBy(xpath="//span[text()=\"Save & Assign\"]")private WebElement saveAndAssignButton;
				 @FindBy(xpath="//div[text()=\"Name is required.\"]")private WebElement nameIsRequriedValidation;	
		@FindBy(xpath="//div[text()=\"Please select at least one Firefighters/Vehicles.\"]")private WebElement pleaseSelectAtLeastOneFirefighterVehicleValidation ;
				@FindBy(xpath="//input[@role='combobox' and @placeholder='Select Vehicles/Cars']")private WebElement vehicleList;
				@FindBy(xpath="//input[@id=\"dx_dx-40d9f0e8-82af-3b0e-a763-d1334d387e59_selectedUsers[786689f549defc0f094e283fcc6a8ba8f5c44494]\"]")private WebElement firefighterInputFieldsForStation01;
				 @FindBy(xpath="//input[@role='combobox' and @placeholder='Select...']")private WebElement firefighterListForSt01;
				@FindBy(xpath="//input[@id=\"dx_dx-40d9f0e8-82af-3b0e-a763-d1334d387e59_selectedUsers[786689f4a73da2eb7d606c9a4ea37c8970b06f0a]\"]")private WebElement firefighterInputFieldsForStation02 ;	
				
				 @FindBy(xpath="//input[@role='combobox' and @placeholder='Select...']")private WebElement  firefighterListForSt02;
			 @FindBy(xpath="//span[contains(text(),\"BG_ALResource\")]")private WebElement resourceName;
				 @FindBy(xpath="//input[@id=\"dx_dx-820e36e4-ebd9-f82c-9b47-6ff93fa7c995_name\"]")private WebElement ResourceTitle;		
		...
		// @FindBy(xpath="")private WebElement ;
			...
			public void TCcreateNewAlarmLoop (WebDriver driver, String St2N,String St1N,String gTodaysDate, String gtimeHHMMSS,String st01R1, String St2R1,String st02V1, String st01V1,String st01FF1, String st02FF1) throws Throwable
			{
				...
				if (fireStationIsRequriedValidation.isDisplayed()&&nicnmaeIsRequriedValidation.isDisplayed()&&alarmCodeIsRequriedValidation.isDisplayed()&&alarmResourceIsRequriedValidation.isDisplayed())
				{
					System.out.println(GREEN+"TC_AlarmLoop_004 - Verify Required Validation for Station, Nic Name, Alarm Loop Code, Resource");
				}
				...
				if (nameIsRequriedValidation.isDisplayed()&&pleaseSelectAtLeastOneFirefighterVehicleValidation.isDisplayed())
				{
					System.out.println(GREEN+"TC_AlarmLoop_007 - Verify Required Validation for Resource Name, Vehicl, firefighter");
				}
